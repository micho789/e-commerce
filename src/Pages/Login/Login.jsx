...
const formik = useFormik({
  ...
  return (
    ...
    <div className='flex justify-center items-center'>
      ...
      <small>Create new Account <Link to={'/register'} className='text-green-400 font-bold hover:text-main' >Register</Link></small>
      <small><Link to={'/forgetPassword'} className='text-green-400 font-bold hover:text-main'>Forget a Password ?</Link></small>
      </div>
      {isLoading? (
